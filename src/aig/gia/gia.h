...
struct Gia_Man_t_
{
    ...
    Gia_Dat_t *    pUData;
    // // selfdefine toggles 
    // Vec_Int_t *    vUser;    // vector of parameters
};
...
static inline void        Gia_ObjUnsetColor( Gia_Man_t * p, int Id )         { p->pReprs[Id].fColorB = p->pReprs[Id].fColorA = 0;                }
...
extern void                Gia_ShowColor( Gia_Man_t* p, char * pFileName, Vec_Int_t* vColorR, Vec_Int_t* vColorG, Vec_Int_t* vColorB );
extern void                Gia_ColorMap( char* pFileName); 
/*=== giaShrink.c ===========================================================*/
